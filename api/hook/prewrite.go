...
// PreWriteHook transforms or vetoes a log entry before it is written.
//
// PreWrite receives borrowed entry metadata and a borrowed field slice. It may
// return the same values unchanged, return a modified Entry, return a replacement
